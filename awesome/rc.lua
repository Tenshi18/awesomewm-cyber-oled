...
--        {description = "Toggle mute", group = "hotkeys"}),
    ...
    awful.key({ modkey },            "b",     function () awful.spawn("/opt/chrome-lin/chrome") end,
...
--              {description = "run prompt", group = "launcher"}),
    ...
    awful.key({ modkey },            "l",     function () 
        local lock_image = gears.filesystem.get_configuration_dir() .. "default/lain2.jpg"
        awful.spawn('i3lock -k --indicator --date-str="%d/%m/%Y" --time-color=a9b0b8ff --date-color=a9b0b8ff --keylayout 0 -i ' .. lock_image)
    end,
...
-- picom
-- Note: Update the path to your picom config or remove if not using picom
...
awful.spawn.with_shell("conky -c ~/.config/conky/conkyrc_weather &")
awful.spawn.with_shell("conky -c ~/.config/conky/conkyrc_sys &")
awful.spawn.with_shell("conky -c ~/.config/conky/conkyrc_disk")

-- NetworkManger applet
awful.spawn("nm-applet")

-- CopyQ (clipboard manager)
awful.spawn.with_shell("copyq --start-server")
